...
Mount::Mount(float x, float y, color_t color) {
...
GLfloat vertex_buffer_data2[3258] = {};
    ...
    vertex_buffer_data2[3]=x+8;
    vertex_buffer_data2[4]=y;
    vertex_buffer_data2[5]=0;

    vertex_buffer_data2[6]=x+4;
    vertex_buffer_data2[7]=y+5.5;
...
void Mount::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}
/*
void Ball::tick() {
